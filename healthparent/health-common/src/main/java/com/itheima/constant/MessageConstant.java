...
public class MessageConstant {
    ...
    public static final String GET_Member_REPORT_FAIL = "获取会员信息失败";
    public static final String GET_Member_REPORT_SUCCESS = "获取会员信息成功";
    public static final String GET_SETMEAL_LIST_SUCCESS = "查询套餐列表数据成功";
    public static final String GET_SETMEAL_LIST_FAIL = "查询套餐列表数据失败";
    public static final String GET_ADDRESS_LIST_SUCCESS = "查询机构地址数据成功";
    public static final String GET_ADDRESS_LIST_FAIL= "查询机构地址数据失败";
    public static final String ADD_ADDRESS_SUCCESS = "新增机构地址成功";
    public static final String ADD_ADDRESS_FAIL= "新增机构地址失败";
    public static final String DELETE_ADDRESS_SUCCESS = "删除机构地址成功";
    public static final String DELETE_ADDRESS_FAIL= "删除机构地址失败";
    public static final String EDIT_ADDRESS_SUCCESS = "编辑机构地址成功";
    public static final String EDIT_ADDRESS_FAIL= "编辑机构地址失败";
    public static final String EDIT_ADDRESS_STATUS_SUCCESS = "更改机构地址运营状态成功";
    public static final String EDIT_ADDRESS_STATUS_FAIL= "更改机构地址运营状态失败";
    public static final String DELETE_SPORT_FAIL = "删除运动项失败";
    public static final String DELETE_SPORT_SUCCESS = "删除运动项成功";
    public static final String ADD_SPORT_FAIL = "助记码重复，请检查后提交";
    public static final String ADD_SPORT_SUCCESS = "新增运动项成功";
    public static final String EDIT_SPORT_FAIL = "编辑运动项失败";
    public static final String EDIT_SPORT_SUCCESS = "编辑运动项成功";
    public static final String QUERY_SPORT_SUCCESS = "查询运动项成功";
    public static final String QUERY_SPORT_FAIL = "查询运动项失败";

    public static final String QUERY_MEMBER_SUCCESS = "查询会员信息成功";
    public static final String QUERY_MEMBER_FAIL = "查询会员信息失败";

    public static final String EDIT_SETMEALLIST_FAIL = "编辑预约列表失败";
    public static final String EDIT_SETMEALLIST_SUCCESS = "编辑预约列表成功";
    public static final String DELETE_SETTINGLIST_FAIL = "删除预约失败";
    public static final String DELETE_SETTINGLIST_SUCCESS = "删除预约成功";
    public static final String ADD_ORDERSETTING_FAIL = "新增预约失败";
    public static final String ADD_ORDERSETTING_SUCCESS = "新增预约成功";
    public static final String QUERY_ADDRESS_SUCCESS = "获取机构成功";
    public static final String QUERY_ADDRESS_FAIL= "获取机构失败";


    public static final String DELETE_FOOD_FAIL = "删除膳食项失败";
    public static final String DELETE_FOOD_SUCCESS = "删除膳食项成功";
    public static final String ADD_FOOD_FAIL = "新增膳食项失败";
    public static final String ADD_FOOD_SUCCESS = "新增膳食项成功";
    public static final String EDIT_FOOD_FAIL = "编辑膳食项失败";
    public static final String EDIT_FOOD_SUCCESS = "编辑膳食项成功";
    public static final String QUERY_FOOD_SUCCESS = "查询膳食项成功";
    public static final String QUERY_FOOD_FAIL = "查询膳食项失败";

    public static final String UPDATE_INFODETAIL_FAIL = "修改会员信息失败";
    public static final String UPDATE_INFODETAIL_SUCCESS= "修改会员信息成功";
}
