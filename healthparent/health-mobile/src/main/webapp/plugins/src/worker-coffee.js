...
function resolveModuleId(id, paths) {
    ...
    while (testPath) {
        ...
        if (typeof alias == "string") {
            ...
            return  alias.location.replace(/\/*$/, "/") + (tail || alias.index || alias.name);
        } else if (alias === false) {
            return "";
        }
